...
def main():  # pragma: no cover
    ...
    try:
        ...
        # TODO: To set the training and testing dataset here
        env = os.environ['ENVIRONMENT']
        trainval_data_uri = f's3://wnzl.{env}.dswb.shared.share/training_dataset/trainval.csv'
        test_data_uri = f's3://wnzl.{env}.dswb.shared.share/training_dataset/test.csv'
        execution = pipeline.start(
            parameters=dict(
                InputData=trainval_data_uri,
                TestData=test_data_uri,
        ...
        execution.wait(delay=30, max_attempts=240)
